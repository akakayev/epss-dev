...
<div class="generic-container">
    ...
    <div id="textReg" class="col-xs-12 col-sm-8 col-md-8">
        ...
        <div class="col-xs-12 col-sm-5 col-md-5">
            ...
            <div>
                <label>Фамилия : ${student.user.lastName}</label>
            </div>
            <div>
                <label>Имя : ${student.user.firstName}</label>
            </div>
            <div>
                <label>Отчество : ${student.user.middleName}</label>
            </div>
            <div>
                <label>Электронная почта : ${student.user.login}</label>
            </div>
            <div>
                <label>Номер зачетки : ${student.recordBookNumber}</label>
            </div>
            <div>
